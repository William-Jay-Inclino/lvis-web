...
const onClickCreate = () => router.push('/warehouse/stock-inventory/item-brand/create')
const onClickEdit = (id: string) => router.push('/warehouse/stock-inventory/item-brand/' + id)
