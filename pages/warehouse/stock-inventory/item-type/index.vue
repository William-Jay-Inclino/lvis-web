...
const onClickCreate = () => router.push('/warehouse/stock-inventory/item-type/create')
const onClickEdit = (id: string) => router.push('/warehouse/stock-inventory/item-type/' + id)
