                    ...
                    <tr>
                        ...
                        <td>
                            <div class="form-check form-switch">
                                <input class="form-check-input" type="checkbox" v-model="permissions.canViewSystem">
                            </div>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <div class="form-check form-switch">
                                <input class="form-check-input" type="checkbox" v-model="permissions.canViewWarehouse">
                            </div>
                        </td>
                    </tr>
                    <tr>
                            ...
                            <div>
                                <div class="form-check form-switch">
                                    <input class="form-check-input" type="checkbox"
                                        v-model="permissions.system.canManageEmployee.create">
                                ...
                                <div class="form-check form-switch">
                                    <input class="form-check-input" type="checkbox"
                                        v-model="permissions.system.canManageEmployee.read">
                                    <label class="form-check-label">
                                        Read
                                    </label>
                                </div>
                                <div class="form-check form-switch">
                                    <input class="form-check-input" type="checkbox"
                                        v-model="permissions.system.canManageEmployee.update">
                                    <label class="form-check-label">
                                        Update
                                    </label>
                                </div>
                                <div class="form-check form-switch">
                                    <input class="form-check-input" type="checkbox"
                                        v-model="permissions.system.canManageEmployee.delete">
                                    <label class="form-check-label">
                                        Delete
                                    </label>
                                </div>
                    ...
                    <tr v-if="permissions.system.canManageDepartment">
                        ...
                        <td class="text-muted">
                            <div>
                                <div class="form-check form-switch">
                                    <input class="form-check-input" type="checkbox"
                                        v-model="permissions.system.canManageDepartment.create">
                                    <label class="form-check-label">
                                        Create
                                    </label>
                                </div>
                                <div class="form-check form-switch">
                                    <input class="form-check-input" type="checkbox"
                                        v-model="permissions.system.canManageDepartment.read">
                                    <label class="form-check-label">
                                        Read
                                    </label>
                                </div>
                                <div class="form-check form-switch">
                                    <input class="form-check-input" type="checkbox"
                                        v-model="permissions.system.canManageDepartment.update">
                                    <label class="form-check-label">
                                        Update
                                    </label>
                                </div>
                                <div class="form-check form-switch">
                                    <input class="form-check-input" type="checkbox"
                                        v-model="permissions.system.canManageDepartment.delete">
                                    <label class="form-check-label">
                                        Delete
                                    </label>
                                </div>
                    ...
                    <tr v-if="permissions.system.canManageAccount">
                        ...
                        <td class="text-muted">
                            <div>
                                <div class="form-check form-switch">
                                    <input class="form-check-input" type="checkbox"
                                        v-model="permissions.system.canManageAccount.create">
                                    <label class="form-check-label">
                                        Create
                                    </label>
                                </div>
                                <div class="form-check form-switch">
                                    <input class="form-check-input" type="checkbox"
                                        v-model="permissions.system.canManageAccount.read">
                                    <label class="form-check-label">
                                        Read
                                    </label>
                                </div>
                                <div class="form-check form-switch">
                                    <input class="form-check-input" type="checkbox"
                                        v-model="permissions.system.canManageAccount.update">
                                    <label class="form-check-label">
                                        Update
                                    </label>
                                </div>
                                <div class="form-check form-switch">
                                    <input class="form-check-input" type="checkbox"
                                        v-model="permissions.system.canManageAccount.delete">
                                    <label class="form-check-label">
                                        Delete
                                    </label>
                                </div>
                    ...
                    <tr v-if="permissions.system.canManageClassification">
                        ...
                        <td class="text-muted">
                            <div>
                                <div class="form-check form-switch">
                                    <input class="form-check-input" type="checkbox"
                                        v-model="permissions.system.canManageClassification.create">
                                    <label class="form-check-label">
                                        Create
                                    </label>
                                </div>
                                <div class="form-check form-switch">
                                    <input class="form-check-input" type="checkbox"
                                        v-model="permissions.system.canManageClassification.read">
                                    <label class="form-check-label">
                                        Read
                                    </label>
                                </div>
                                <div class="form-check form-switch">
                                    <input class="form-check-input" type="checkbox"
                                        v-model="permissions.system.canManageClassification.update">
                                    <label class="form-check-label">
                                        Update
                                    </label>
                                </div>
                                <div class="form-check form-switch">
                                    <input class="form-check-input" type="checkbox"
                                        v-model="permissions.system.canManageClassification.delete">
                                    <label class="form-check-label">
                                        Delete
                                    </label>
                                </div>
